...
.article-paper { background: white; border-radius: 24px; padding: 50px; box-shadow: 0 10px 40px rgba(0,0,0,0.05); margin-bottom: 40px; }
...
.article-body { font-size: 1.1rem; line-height: 1.8; color: #444; white-space: pre-wrap; margin-bottom: 50px; min-height: 200px; }
